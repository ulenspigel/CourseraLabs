...
public class ActivityLoaderActivity extends Activity {
	...
	static private final String URL = "http://www.google.com.ua";
	...
	private void startExplicitActivation() {
		...
		// TODO - Start an Activity using that intent and the request code defined above (Done)
	...
	private void startImplicitActivation() {
		...
		// TODO - Create a base intent for viewing a URL (Done)
		// (HINT:  second parameter uses Uri.parse())
        Intent baseIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URL));
		
		// TODO - Create a chooser intent, for choosing which Activity will carry out the baseIntent (Done)
		// (HINT: Use the Intent class' createChooser() method)
		Intent chooserIntent = Intent.createChooser(baseIntent, CHOOSER_TEXT);
        
		Log.i(TAG,"Chooser Intent Action:" + chooserIntent.getAction());
        
		// TODO - Start the chooser Activity, using the chooser intent (Done)
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// TODO - Process the result only if this method received both a (Done)
		// RESULT_OK result code and a recognized request code
		// If so, update the Textview showing the user-entered text.
		if (requestCode == GET_TEXT_REQUEST_CODE) {
			if (resultCode == RESULT_OK) {
				String userInput = data.getStringExtra("ENTERED_STRING");
