...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> resourceIDs = getArguments().getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] convertedResourceIDs = resourceIDs.toArray(new Integer[resourceIDs.size()]);

		// TODO: Start the DownloaderTask (+)
		downloaderTask.execute(convertedResourceIDs);
	}
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != MainActivity.IS_ALIVE) {
								...
								// TODO: If not, create a PendingIntent using the restartMainActivityIntent (+)
