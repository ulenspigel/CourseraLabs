	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int checkedPriorityIndex = mPriorityRadioGroup.indexOfChild(findViewById(
						mPriorityRadioGroup.getCheckedRadioButtonId()));
				switch (checkedPriorityIndex) {
					case 0: priority = Priority.LOW;
						    break;
					case 1: priority = Priority.MED;
						    break;
				...
				Status status = null;
				int checkedStatusIndex = mStatusRadioGroup.indexOfChild(findViewById(
						mStatusRadioGroup.getCheckedRadioButtonId()));
				switch (checkedStatusIndex) {
					case 0: status = Status.DONE;
							break;
					case 1: status = Status.NOTDONE;
							break;
				}
